...
<body>
    <div @class(['wrapper'])>
        ...
        {{-- Header --}}
        <div @class(['header'])>
            <span @class(['welcome-emoji'])><img src="{{ asset('assets/images/laladia-logo.png') }}"
                    alt="Logo"></span>
                ...
                <div @class(['coupon-wrap'])>
                    <div @class(['coupon-box'])>
                        <div @class(['coupon-discount'])>
                            {{ $coupon->type === 'percentage' ? $coupon->value . '% OFF' : '৳' . number_format($coupon->value, 0) . ' OFF' }}
                        </div>
                        <p @class(['coupon-sub'])>
                            {{ $coupon->type === 'percentage' ? 'on your first order' : 'flat discount on your first order' }}
