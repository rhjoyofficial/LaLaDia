    ...
    <div x-data="customerList()" x-init="init()" x-cloak>
        ...
        <div class="bg-white border border-champagne rounded-xl mb-4 p-4 flex flex-wrap gap-3">
            <div class="relative flex-1 min-w-52">
                ...
                <input type="text" x-model="search" @input.debounce.400ms="load(1)" placeholder="Name, email, or phone…"
                    autocomplete="one-time-code" name="search"
                                ...
                                <tr class="hover:bg-cream transition">
                                    ...
                                    <td class="px-5 py-3">
                                        <template x-if="c.is_guest">
                                            <span
                                                class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-muted">Guest</span>
                                        </template>
                                        <template x-if="!c.is_guest">
                                            <button @click="toggleActive(c)"
                                                ...
                                                :class="c.is_active ? 'bg-green-700 text-white hover:bg-green-600' :
        ...
        <div x-show="createModal.open" x-transition.opacity
            ...
            <div @click.outside="createModal.open = false" class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
                ...
                <div class="space-y-3">
                    <div>
                        <label class="block text-sm font-medium text-brown mb-1">Full Name <span
                        ...
                        <p x-show="createModal.errors.name" class="text-xs text-red-500 mt-1"
                            x-text="createModal.errors.name?.[0]"></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-brown mb-1">Email <span
                                class="text-red-500">*</span></label>
                        ...
                        <p x-show="createModal.errors.email" class="text-xs text-red-500 mt-1"
                    ...
                    <div>
                        <label class="block text-sm font-medium text-brown mb-1">Password <span
                                class="text-red-500">*</span></label>
                        ...
                        <p x-show="createModal.errors.password" class="text-xs text-red-500 mt-1"
            ...
            <div @click.outside="editModal.open = false" class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p x-show="editModal.errors.name" class="text-xs text-red-500 mt-1"
                    ...
                    <div>
                        ...
                        <p x-show="editModal.errors.email" class="text-xs text-red-500 mt-1"
            ...
            <div @click.outside="passwordModal.open = false" class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-muted">For: <span class="font-medium text-brown"
                                x-text="passwordModal.customer?.name"></span></p>
                    </div>
                </div>
                <div class="space-y-3">
                    <div>
                        <label class="block text-sm font-medium text-brown mb-1">New Password <span
                                class="text-red-500">*</span></label>
                        ...
                        <p x-show="passwordModal.errors.password" class="text-xs text-red-500 mt-1"
                            x-text="passwordModal.errors.password?.[0]"></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-brown mb-1">Confirm Password <span
                                class="text-red-500">*</span></label>
                        <input x-model="passwordModal.password_confirmation" type="password"
        ...
        function customerList() {
            return {
                ...
                async changePassword() {
                    ...
                    try {
                        const r = await fetch(
                            `/api/v1/admin/customers/${this.passwordModal.customer.id}/change-password`, {
                                method: 'PATCH',
                                headers: {
                                    ...this.h(),
                                    'Content-Type': 'application/json'
