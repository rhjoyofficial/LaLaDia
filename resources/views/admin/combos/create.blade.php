    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="bg-white border border-champagne rounded-xl p-5 space-y-4">
                ...
                <div class="bg-blue-50 border border-blue-100 rounded-lg px-3 py-2 text-[10px] text-blue-600">
                    Quantity-based tier prices (discounts, gifts) can be added after saving the combo.
                </div>
            </div>
