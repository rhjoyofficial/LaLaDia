...
@push('styles')
<style>
    .qty-stepper { display: flex; align-items: center; border: 1px solid var(--color-border); border-radius: 10px; overflow: hidden; background: var(--color-surface); }
    .qty-stepper button { width: 2rem; height: 2rem; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 1rem; cursor: pointer; transition: background 0.15s; color: var(--color-text-muted); }
    .qty-stepper button:hover { background: var(--color-bg-soft); color: var(--color-text-secondary); }
    .qty-stepper span { width: 2rem; text-align: center; font-size: 0.875rem; font-weight: 600; color: var(--color-text); }
    .coupon-wrap { display: flex; align-items: center; border-radius: 12px; overflow: hidden; border: 1px solid var(--color-border); background: var(--color-bg-soft); transition: border-color 0.2s; }
    .coupon-wrap:focus-within { border-color: var(--color-primary); }
    /* Discount row: flex when visible (JS toggles .hidden) */
    #pageDiscountRow { display: flex; justify-content: space-between; }
</style>
@endpush
            ...
            <div class="lg:col-span-2">
                <div class="card overflow-hidden">
                    ...
                    <div class="px-6 pt-6 pb-0 flex items-center justify-between"
                        ...
                        <span id="pageCartCount" class="text-sm font-medium"
                              style="color: var(--color-text-muted);">0 items</span>
                    </div>
                            ...
                            @foreach (range(1, 2) as $i)
                                <div class="flex items-center gap-4 py-5"
                                    ...
                                    <div class="flex-1 space-y-2">
                                        <div class="h-4 rounded-lg w-2/3" style="background: var(--color-bg-soft);"></div>
                                        <div class="h-3 rounded-lg w-1/3" style="background: var(--color-bg-soft);"></div>
                                        <div class="flex justify-between mt-3">
                                            <div class="h-8 w-28 rounded-xl" style="background: var(--color-bg-soft);"></div>
                                            <div class="h-5 w-20 rounded" style="background: var(--color-bg-soft);"></div>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                ...
                <div class="card p-6 sticky top-24">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-base font-semibold" style="color: var(--color-text-secondary);">Total</span>
