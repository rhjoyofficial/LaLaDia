        ...
        <div class="max-w-8xl mx-auto px-4 py-6 md:py-10">
            ...
            <nav class="flex text-xs mb-6" style="color: var(--color-text-muted);">
                <ol class="flex items-center gap-1.5">
                    ...
                    <li><a href="{{ route('cart.view') }}" onmouseover="this.style.color='var(--color-primary)'"
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="card p-5">
                            <div class="flex items-center gap-3 mb-5">
                                ...
                                <h3 class="text-base font-semibold" style="color: var(--color-text);">Customer Information
                                </h3>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="co-label" for="co_email">
                                        Email <span class="font-normal normal-case"
                                            style="color: var(--color-text-placeholder);">(optional)</span>
                                    </label>
                                ...
                                <div>
                                    ...
                                    <input id="co_city" name="city" type="text" placeholder="Dhaka"
                                ...
                                <div class="sm:col-span-2">
                                    <label class="co-label" for="co_notes">
                                        Order Notes <span class="font-normal normal-case"
                                            style="color: var(--color-text-placeholder);">(optional)</span>
                                    </label>
                        ...
                        <div class="card p-5">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3">
                                ...
                                <label class="payment-label">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold" style="color: var(--color-text);">Cash on Delivery
                                        </p>
                                        <p class="text-xs mt-0.5" style="color: var(--color-text-muted);">Pay when order
                                            arrives</p>
                                    </div>
                                </label>
                                ...
                                <label class="payment-label" style="opacity: 0.65; cursor: not-allowed;">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs mt-0.5" style="color: var(--color-text-muted);">bKash, Nagad,
                                            Cards</p>
                                    </div>
                                </label>
                            </div>
                        ...
                        <div class="card p-5">
                            ...
                            <div class="coupon-bar">
                                <svg class="w-4 h-4 ml-3 shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" style="color: var(--color-primary);">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                                </svg>
                                <input id="co_coupon" type="text" placeholder="Enter promo code" autocomplete="off"
                    ...
                    <div class="sticky top-6 space-y-4">
                        <div class="card p-6">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span id="coItemCount" class="text-xs font-medium"
