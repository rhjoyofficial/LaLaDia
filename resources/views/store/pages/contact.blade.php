    ...
    <div
        ...
        <section
            ...
            <div class="relative z-10 text-center px-4 max-w-3xl mx-auto">
                ...
                <p class="text-sm md:text-base text-cream/80 max-w-xl mx-auto leading-relaxed font-light line-clamp-2">
                    {{ $data['subtitle'] }}
                </p>
        ...
        <div class="max-w-8xl mx-auto px-4 py-24">
            <div class="grid lg:grid-cols-12 gap-16 lg:gap-24">
                ...
                <div class="lg:col-span-5 space-y-16">
                    <div>
                        <h2 class="text-3xl font-playfair text-brand mb-4 tracking-wide">Direct Lines</h2>
                        <div class="w-12 h-px bg-primary mb-10"></div>
                        <p class="text-sm leading-relaxed text-muted font-light mb-12">
                    ...
                    <div class="space-y-10">
                        ...
                        <div class="group flex items-start gap-6">
                            <div
                                class="w-12 h-12 flex items-center justify-center border border-champagne bg-white text-primary rounded-full group-hover:bg-primary group-hover:text-white transition-colors duration-500 shrink-0">
                                <i class="fa-solid fa-phone group-hover:text-white"></i>
                            </div>
                            <div>
                                <p class="text-[10px] uppercase tracking-[0.2em] text-taupe mb-1">Call Us</p>
                                <p class="text-lg font-playfair text-brand tracking-wide">{{ $data['phone'] }}</p>
                            </div>
                        </div>
                        ...
                        <div class="group flex items-start gap-6">
                            ...
                            <div>
                                <p class="text-[10px] uppercase tracking-[0.2em] text-taupe mb-1">Email Us</p>
                                <p class="text-lg font-playfair text-brand tracking-wide">{{ $data['email'] }}</p>
                            </div>
                        </div>
                        ...
                        <div class="group flex items-start gap-6">
                            ...
                            <div>
                                <p class="text-[10px] uppercase tracking-[0.2em] text-taupe mb-1">Visit Us</p>
                                <p class="text-sm text-muted leading-relaxed font-light max-w-[200px]">
                                    {{ $data['address'] }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-primary p-10 relative overflow-hidden group shadow-2xl">
                        ...
                        <div class="relative z-10">
                            ...
                            <p class="text-xs text-ivory/80 mb-8 font-light leading-relaxed">Available from 09:00 AM to
                ...
                <div class="lg:col-span-7 space-y-16">
                    ...
                    <!-- Elegant Form -->
                    <div class="bg-white border border-champagne p-10 md:p-16 shadow-xl relative">
                        <div
                            class="absolute top-0 right-0 w-32 h-32 bg-ivory/50 rounded-full -mr-16 -mt-16 pointer-events-none">
                        </div>
                        <h2 class="text-3xl font-playfair text-brand mb-2 tracking-wide">Send a Message</h2>
                        <p class="text-xs text-muted font-light mb-10">We will get back to you as soon as possible.</p>

                        <form action="#" class="grid md:grid-cols-2 gap-x-8 gap-y-10 relative z-10">
                            <div class="space-y-2">
                                <label class="text-[9px] uppercase tracking-[0.2em] text-taupe">Full Name</label>
                                <input type="text"
                                    class="w-full bg-transparent border-b border-champagne py-3 text-sm text-brand placeholder:text-disabled focus:outline-none focus:border-primary transition-colors duration-300"
                                    placeholder="CM Moin">
                            </div>
                            <div class="space-y-2">
                                <label class="text-[9px] uppercase tracking-[0.2em] text-taupe">Email Address</label>
                                <input type="email"
                                    class="w-full bg-transparent border-b border-champagne py-3 text-sm text-brand placeholder:text-disabled focus:outline-none focus:border-primary transition-colors duration-300"
                                    placeholder="cmmoin@gmail.com">
                            </div>
                            <div class="md:col-span-2 space-y-2">
                                <label class="text-[9px] uppercase tracking-[0.2em] text-taupe">Subject</label>
                                <input type="text"
                                    class="w-full bg-transparent border-b border-champagne py-3 text-sm text-brand placeholder:text-disabled focus:outline-none focus:border-primary transition-colors duration-300"
                                    placeholder="How can we help?">
                            </div>
                            <div class="md:col-span-2 space-y-2">
                                <label class="text-[9px] uppercase tracking-[0.2em] text-taupe">Message</label>
                                <textarea rows="4"
                                    class="w-full bg-transparent border-b border-champagne py-3 text-sm text-brand placeholder:text-disabled focus:outline-none focus:border-primary transition-colors duration-300 resize-none"
                    ...
                    <div>
                        ...
                        <div
                            class="aspect-video w-full bg-champagne border border-champagne shadow-lg overflow-hidden group">
