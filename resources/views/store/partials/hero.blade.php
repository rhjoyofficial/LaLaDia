<section class="bg-primary/10 py-6 md:py-8 px-4 lg:px-8">
    <div class="max-w-8xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 grid-rows-none lg:grid-rows-4 gap-4">
            ...
            <div
                                ...
                                <div class="flex flex-col lg:flex-row justify-between items-center gap-8 w-full">
                                    <div>
                                        ...
                                        <div class="flex items-center gap-4 mb-8">
                                            <span
                                                class="text-3xl font-light text-disabled">{{ str_pad($loop->iteration, 2, '0', STR_PAD_LEFT) }}</span>
                                            <div class="h-px w-12 bg-champagne"></div>
                                            <div class="text-muted text-sm max-w-xs">
                ...
                <div
                    class="absolute bottom-4 left-4 md:bottom-6 md:left-16 flex items-center gap-1 md:gap-3 text-taupe z-10">
                    ...
                    {{-- Instagram --}}
                    <a href="#"
                        class="w-8 h-8 md:w-12 md:h-12 rounded-full border border-secondary/50 md:border-champagne flex items-center justify-center hover:bg-[linear-gradient(45deg,#f09433_0%,#e6683c_25%,#dc2743_50%,#cc2366_75%,#bc1888_100%)] hover:border-transparent transition-colors group">
                        <svg class="w-4 h-4 md:w-5 md:h-5 fill-current text-taupe group-hover:text-white"
                            viewBox="0 0 448 512">
                            <path
                    ...
                    <a href="https://wa.me/8801334943785" target="_blank"
                        class="w-8 h-8 md:w-12 md:h-12 rounded-full border border-secondary/50 md:border-champagne flex items-center justify-center hover:bg-[#25D366] hover:border-[#25D366] transition-colors group">
                        <svg class="w-4 h-4 md:w-5 md:h-5 fill-current text-taupe group-hover:text-white"
                    ...
                    {{-- TikTok --}}
                    <a href="#"
                        class="w-8 h-8 md:w-12 md:h-12  rounded-full border border-secondary/50 md:border-champagne flex items-center justify-center hover:bg-black hover:border-black transition-colors group">
                        <svg class="w-4 h-4 md:w-5 md:h-5 fill-current text-taupe group-hover:text-white"
                            viewBox="0 0 448 512">
                            <path
            ...
            <div class="col-span-12 lg:col-span-3 lg:row-span-1 lg:col-start-10 bg-white rounded-3xl p-6 shadow-sm">
                <h3 class="text-sm font-bold text-brown mb-4">Explore Categories</h3>
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex flex-col justify-between h-full flex-1 z-10">
                        ...
                        <div>
                            <span class="text-sm font-bold text-taupe uppercase tracking-wider">New
                                Arrival</span>
                        </div>
            ...
            <div
                ...
                <div
                    ...
                    {{-- Play / Pause --}}
                    <button id="hero-vid-pp"
                        class="text-white p-1.5 rounded-full hover:bg-white/20 transition-colors">
                        <svg id="hero-pause-ic" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            fill="currentColor" class="w-5 h-5">
                            <path fill-rule="evenodd"
                                d="M6.75 5.25a.75.75 0 0 1 .75-.75H9a.75.75 0 0 1 .75.75v13.5a.75.75 0 0 1-.75.75H7.5a.75.75 0 0 1-.75-.75V5.25Zm7.5 0A.75.75 0 0 1 15 4.5h1.5a.75.75 0 0 1 .75.75v13.5a.75.75 0 0 1-.75.75H15a.75.75 0 0 1-.75-.75V5.25Z"
                                clip-rule="evenodd" />
                        </svg>
                        <svg id="hero-play-ic" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                    ...
                    {{-- Mute / Unmute --}}
                    <button id="hero-vid-mute"
                        class="text-white p-1.5 rounded-full hover:bg-white/20 transition-colors flex items-center gap-1.5">
                        <span id="hero-sound-label" class="text-[11px] font-medium hidden">Tap for sound</span>
                        <svg id="hero-muted-ic" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            fill="currentColor" class="w-5 h-5">
                            <path
                        ...
                        <svg id="hero-sound-ic" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            fill="currentColor" class="w-5 h-5 hidden">
                            <path
