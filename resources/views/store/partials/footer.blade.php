        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div class="space-y-5">
                <a href="{{ route('home') }}" class="block">
                    ...
                    <span class="text-2xl font-heading font-bold hidden" style="color: var(--color-primary);">LaLaDia</span>
                </a>
                <p class="text-sm leading-relaxed" style="color: var(--color-text-muted);">
                    Pure Sundarbans honey, authentic Bengali pickles, Royal Essence Ghee, and premium seasonal produce — trusted by thousands across Bangladesh.
                </p>
                {{-- Social icons --}}
                <div>
                    <p class="text-xs font-bold uppercase tracking-widest mb-3" style="color: var(--color-text-muted);">Follow Us</p>
                    <div class="flex gap-2">
                        @php
                            $socials = [
                                'facebook'  => ['url' => 'https://www.facebook.com/LaLaDiaOfficial', 'label' => 'Facebook'],
                                'youtube'   => ['url' => 'https://www.youtube.com/@LaLaDiaOfficial',  'label' => 'YouTube'],
                            ...
                            <li>
                                <a href="{{ route($link['route']) }}"
                                   ...
                                   onmouseout="this.style.color='var(--color-text-muted)'">
                                    <span class="w-1 h-1 rounded-full flex-shrink-0" style="background: var(--color-primary);"></span>
                                    {{ $link['label'] }}
                                </a>
                            </li>
                        @endif
