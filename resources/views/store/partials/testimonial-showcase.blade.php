    ...
    <div class="max-w-8xl mx-auto">
        ...
        <div class="flex items-end justify-between gap-6 mb-10">
            ...
            <div class="flex gap-2 shrink-0">
                <button
                    class="testi-prev w-10 h-10 rounded-xl flex items-center justify-center cursor-pointer transition-all duration-200"
                ...
                <button
                    class="testi-next w-10 h-10 rounded-xl flex items-center justify-center cursor-pointer transition-all duration-200"
                    style="border: 1px solid var(--color-border); color: var(--color-text-muted);"
                    onmouseover="this.style.background='var(--color-primary)'; this.style.color='white'; this.style.borderColor='var(--color-primary)'"
                    onmouseout="this.style.background='transparent'; this.style.color='var(--color-text-muted)'; this.style.borderColor='var(--color-border)'">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="swiper-wrapper items-stretch pb-4">
                    ...
                    <div class="flex flex-col w-full h-full rounded-2xl p-5 transition-all duration-300 hover:shadow-lg"
                        ...
                        <div class="media-container mb-5">
                            <div class="media-frame image-preview-trigger cursor-zoom-in rounded-xl overflow-hidden"
                                style="aspect-ratio: 4/3;" data-image="{{ asset('assets/review/review-3.jpeg') }}">
                                <img src="{{ asset('assets/review/review-3.jpeg') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="Customer review">
                            </div>
                        </div>
                        <div class="flex items-center gap-3 pt-4 mt-auto"
                            ...
                            <div class="w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm shrink-0"
                                style="background: rgba(var(--color-primary-rgb),0.12); color: var(--color-primary);">R
                            </div>
                            <div>
                ...
                <div class="swiper-slide flex h-auto">
                    <div class="flex flex-col w-full h-full rounded-2xl p-5 transition-all duration-300 hover:shadow-lg"
                        style="background: var(--color-surface); border: 1px solid var(--color-border);">
                        <div class="media-container mb-5">
                            <div class="media-frame" data-video data-video-type="html5"
                                data-video-src="{{ asset('assets/video/video-file.mp4') }}" data-video-lazy="true"
                        ...
                        <div class="flex items-center gap-3 pt-4 mt-auto"
                            style="border-top: 1px solid var(--color-border);">
                            <div class="w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm shrink-0"
                                style="background: rgba(var(--color-primary-rgb),0.12); color: var(--color-primary);">M
                            </div>
                            <div>
                ...
                <div class="swiper-slide flex h-auto">
                    <div class="flex flex-col w-full h-full rounded-2xl p-5 transition-all duration-300 hover:shadow-lg"
                        ...
                        <div class="media-container mb-5">
                            ...
                            <p class="text-sm leading-relaxed italic font-bengali"
                                style="color: var(--color-text-secondary);">
                                "সুন্দরবনের মধু সত্যিই অসাধারণ। এর রঙ, ঘ্রাণ, স্বাদ — সব কিছুই অন্য রকম। বাজারের মধুর
                                সাথে তুলনাই হয় না। পরিবারের সবাই খুব পছন্দ করেছে।"
                            </p>
                        </div>
                        <div class="flex items-center gap-3 pt-4 mt-auto"
                            style="border-top: 1px solid var(--color-border);">
                            <div class="w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm shrink-0"
                                style="background: rgba(var(--color-primary-rgb),0.12); color: var(--color-primary);">A
                            </div>
                            <div>
                ...
                <div class="swiper-slide flex h-auto">
                    <div class="flex flex-col w-full h-full rounded-2xl p-5 transition-all duration-300 hover:shadow-lg"
                        ...
                        <div class="media-container mb-5">
                            ...
                            <p class="text-sm leading-relaxed italic font-bengali"
                                style="color: var(--color-text-secondary);">
                                "Royal Essence Ghee-র সুবাস রান্নাঘর ভরিয়ে দেয়। এত সুন্দর রঙ, এত ঘন — বহু বছর পর আসল
                                গরুর ঘি পেলাম। পোলাওয়ে দিলে স্বাদ দ্বিগুণ হয়ে যায়!"
                            </p>
                        </div>
                        <div class="flex items-center gap-3 pt-4 mt-auto"
                            style="border-top: 1px solid var(--color-border);">
                            <div class="w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm shrink-0"
                                style="background: rgba(var(--color-primary-rgb),0.12); color: var(--color-primary);">F
                            </div>
                            <div>
                                <p class="text-sm font-bold" style="color: var(--color-text);">Fatima Khanam</p>
                                <p class="text-xs" style="color: var(--color-text-muted);">Verified Buyer · Chittagong
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide flex h-auto">
                    <div class="flex flex-col w-full h-full rounded-2xl p-5 transition-all duration-300 hover:shadow-lg"
                        ...
                        <div class="media-container mb-5">
                            ...
                            <p class="text-sm leading-relaxed italic font-bengali"
                                style="color: var(--color-text-secondary);">
                                "ইলিশ মাছের আচার খেয়ে অবাক হয়ে গেলাম! এটা সত্যিই ঐতিহ্যবাহী রেসিপিতে তৈরি — মায়ের
                                হাতের আচারের কথা মনে পড়ে গেল। বারবার অর্ডার করব।"
                            </p>
                        </div>
                        <div class="flex items-center gap-3 pt-4 mt-auto"
                            style="border-top: 1px solid var(--color-border);">
                            <div class="w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm shrink-0"
                                style="background: rgba(var(--color-primary-rgb),0.12); color: var(--color-primary);">S
                            </div>
                            <div>
...
{{-- IMAGE PREVIEW MODAL --}}
<div id="image-preview-modal" class="fixed inset-0 hidden items-center justify-center z-50 p-6"
    style="background: rgba(0,0,0,0.85); backdrop-filter: blur(6px);">
    <img id="preview-image" class="max-h-[90vh] max-w-[90vw] rounded-xl shadow-2xl" src="" alt="Review">
</div>
