                    ...
                    <div>
                        ...
                        <p class="text-xs text-taupe">
                            ...
                            @if ($zone->free_shipping_threshold)
                                &middot; Free over <span
                                    class="font-bengali">&#2547;{{ number_format($zone->free_shipping_threshold, 0) }}</span>
                            @endif
                        </p>
                    </div>
                </label>
            ...
            applyCoupon() {
                ...
                this.refreshPreview().then(() => {
                    if (this.pricing.coupon_discount > 0) {
                        this.couponMessage =
                            `Coupon "${this.pricing.coupon_code}" applied! You save &#2547;${this.pricing.coupon_discount.toFixed(0)}`;
                        this.couponError = false;
