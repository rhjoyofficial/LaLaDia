    ...
    <div class="flex items-center justify-center min-h-[85vh] bg-cream px-4 sm:px-6 lg:px-8 font-sans">
        <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-champagne">
            ...
            <form id="resetForm" class="mt-8 space-y-5" novalidate>
                ...
                <div>
                    <label class="block text-sm font-medium text-brown">Email Address</label>
                    <p class="mt-1 px-4 py-3 text-sm text-muted bg-cream border border-champagne rounded-lg">
                        {{ $email ?? request('email') }}
                    </p>
                </div>
                ...
                {{-- New Password --}}
                <div>
                    <label for="password" class="block text-sm font-medium text-brown">New Password</label>
                ...
                {{-- Confirm Password --}}
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-brown">Confirm Password</label>
                    <div class="mt-1 relative">
