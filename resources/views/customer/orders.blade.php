...
@push('styles')
<style>
    .order-status { display: inline-flex; align-items: center; padding: 0.2rem 0.65rem; border-radius: 9999px; font-size: 0.7rem; font-weight: 700; text-transform: capitalize; letter-spacing: 0.02em; }
    ...
    .status-confirmed  { background: rgba(99,102,241,0.12); color: #4338CA; }
    .status-shipped    { background: rgba(99,102,241,0.12); color: #4338CA; }
    .status-delivered  { background: rgba(34,197,94,0.12);  color: #15803D; }
    .status-cancelled  { background: rgba(239,68,68,0.12);  color: var(--color-danger); }
</style>
@endpush
