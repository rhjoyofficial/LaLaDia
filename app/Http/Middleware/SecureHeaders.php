...
class SecureHeaders
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        $csp = implode('; ', [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://connect.facebook.net https://www.google-analytics.com https://cdn.jsdelivr.net http://127.0.0.1:* http://localhost:*",
            ...
            "media-src 'self' blob:",
            "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://www.facebook.com ws://127.0.0.1:* ws://localhost:* http://127.0.0.1:* http://localhost:*",
