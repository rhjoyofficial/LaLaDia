...
Route::post('/landing/{slug}/preview', [LandingCheckoutController::class, 'preview'])->middleware('throttle:120,1');
Route::post('/landing/{slug}/checkout', [LandingCheckoutController::class, 'checkout'])->middleware('throttle:20,1');
