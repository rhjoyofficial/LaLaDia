...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('settings')->insert([
            ...
            // Contact
            ['group' => 'contact', 'key' => 'admin_email',    'type' => 'string',  'value' => config('laladia.admin_email', ''),    'label' => 'Admin Email',         'description' => 'Primary admin notification email.',        'is_readonly' => false, 'sort_order' => 10, 'created_at' => $now, 'updated_at' => $now],
            ['group' => 'contact', 'key' => 'admin_phone',    'type' => 'string',  'value' => config('laladia.admin_phone', ''),    'label' => 'Admin Phone',         'description' => 'Primary admin phone (for SMS alerts).',    'is_readonly' => false, 'sort_order' => 11, 'created_at' => $now, 'updated_at' => $now],
